...
export default function MainMenu() {
    ...
    const ordersInfo = [
        { user: 'Jesus T.', timeOrdered: '2025-01-02T10:00', orderID: 'UCA-00007', items: 3, timeSpent: '$94.00' },
        { user: 'Uriel R.', timeOrdered: '2025-01-02T09:59', orderID: 'UCA-00006', items: 1, timeSpent: '$44.00' },
        { user: 'Andres D.', timeOrdered: '2025-01-02T09:57', orderID: 'UCA-00005', items: 3, timeSpent: '$110.00' },
        { user: 'Emilio V.', timeOrdered: '2025-01-02T09:55', orderID: 'UCA-00004', items: 2, timeSpent: '$67.00' },
        { user: 'Damian G.', timeOrdered: '2025-01-02T09:52', orderID: 'UCA-00003', items: 2, timeSpent: '$90.00' },
        { user: 'Shalem V.', timeOrdered: '2025-01-02T09:52', orderID: 'UCA-00002', items: 3, timeSpent: '$108.88' },
        { user: 'Diego D.', timeOrdered: '2025-01-02T09:50', orderID: 'UCA-00001', items: 4, timeSpent: '$148.00' }, 
    ];

    const sortedOrders = [...ordersInfo].sort(
            (a, b) => new Date(b.timeOrdered) - new Date(a.timeOrdered)
    );
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.sectionsContainer}>
            ...
            <TouchableOpacity style={styles.buttonDelivered_selected} onPress={() => router.push('/orders/deliveredPreview')}>
                <Text style={styles.buttonDelivered_selected_text}>Delivered</Text>
            </TouchableOpacity>
        </View>
        ...
        <Modal transparent animationType="fade" visible={orderMenuVisible} onRequestClose={() => setOrderMenuVisible(false)} >
            <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={() => setOrderMenuVisible(false)}>
                <View style={styles.popup}>
                    ...
                    <TouchableOpacity style={styles.buttonDelivered_selected} onPress={() => { setOrderMenuVisible(false); router.push('/orders/deliveredPreview'); }} >
                        <Text style={styles.buttonDelivered_selected_text}>Delivered</Text>
                    </TouchableOpacity>
                </View>
            </TouchableOpacity>
