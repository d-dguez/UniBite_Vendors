...
export default function MainMenu() {
    ...
    const ordersInfo = [
        { user: 'Diego D.', timeOrdered: '2025-01-02T09:50', orderID: 'UCA-00001', timeSpent: '03:15' },
        { user: 'Shalem V.', timeOrdered: '2025-01-02T09:52', orderID: 'UCA-00002', timeSpent: '02:40' },
        { user: 'Damian G.', timeOrdered: '2025-01-02T09:52', orderID: 'UCA-00003', timeSpent: '02:15' },
        { user: 'Emilio V.', timeOrdered: '2025-01-02T09:55', orderID: 'UCA-00004', timeSpent: '01:15' },
        { user: 'Andres D.', timeOrdered: '2025-01-02T09:57', orderID: 'UCA-00005', timeSpent: '01:00' },
        { user: 'Uriel R.', timeOrdered: '2025-01-02T09:59', orderID: 'UCA-00006', timeSpent: '00:10' },
        { user: 'Jesus T.', timeOrdered: '2025-01-02T10:00', orderID: 'UCA-00007', timeSpent: '00:05' },
    ];
    ...
    const styles = StyleSheet.create({
        ...
        buttonReady_selected: { 
            height: 40,
            width: 85,
            backgroundColor: '#83fc18',
            borderRadius: 15,
            justifyContent: 'center',
            alignItems: 'center',
            marginInline: 5,
        },
        buttonReady_selected_text: { 
            color: '#000', 
            fontWeight: '700',
            fontFamily: 'helvetica',
        },
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.sectionsContainer}>
            ...
            <TouchableOpacity style={styles.buttonReady_selected} onPress={() => router.push('/orders/readyPreview')}>
                <Text style={styles.buttonReady_selected_text}>Ready</Text>
            </TouchableOpacity>
        ...
        <Modal transparent animationType="fade" visible={orderMenuVisible} onRequestClose={() => setOrderMenuVisible(false)} >
            <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={() => setOrderMenuVisible(false)}>
                <View style={styles.popup}>
                    ...
                    <TouchableOpacity style={styles.buttonReady_selected} onPress={() => { setOrderMenuVisible(false); router.push('/orders/readyPreview'); }} >
                        <Text style={styles.buttonReady_selected_text}>Ready</Text>
                    </TouchableOpacity>
